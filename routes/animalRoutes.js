...
import { getAnimaisDisponiveis, getAnimal, cadastrarAnimal, getPublicacoes, confirmarAdocao, getAnimalFilter} from '../controllers/animalController.js';
...
router.get('/filtrar', getAnimalFilter)
